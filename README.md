...
- i tend to use simplified color themes based upon bigger themes, yet at this moment i use (without modifications) [meliora](https://github.com/meliora-theme/theme)
